...
| 用例 ID | 需求引用 | 业务流程 | 分类 | 接口 | 前置条件 | 数据准备 | API 断言 | DB 断言 | 风险 | 需确认 | 执行状态 | 清理 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| API-001 | REQ-001 | 示例业务流程 | normal | POST /example | 示例前置 | 示例 fixture | 状态码/业务码 | 状态/关联记录 | low | no | planned | none |
